...
<article class="section-space" data-reveal="fade-up"><div class="container"><div class="row justify-content-center"><div class="col-lg-8"><p class="lead">{{ $article->excerpt }}</p><div class="content-copy">{{ $article->body }}</div></div></div></div></article>
@endsection
